...
public class Variaveis6 extends AppCompatActivity {
    ...
    public void verificar(View view){
        ...
        if(edit_text.getText().toString().equals("int numeroDePrateleiras = 10;") || edit_text.getText().toString().equals("int numeroDePrateleiras= 10;") ||edit_text.getText().toString().equals("int numeroDePrateleiras =10;")||edit_text.getText().toString().equals("int numeroDePrateleiras=10;")||edit_text.getText().toString().equals("int numeroDePrateleiras = 10 ;") || edit_text.getText().toString().equals("int numeroDePrateleiras= 10 ;") ||edit_text.getText().toString().equals("int numeroDePrateleiras =10 ;")||edit_text.getText().toString().equals("int numeroDePrateleiras=10 ;")){
