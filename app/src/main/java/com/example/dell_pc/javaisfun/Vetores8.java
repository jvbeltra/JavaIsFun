...
public class Vetores8 extends AppCompatActivity {
    public int cont=0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button28).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button19).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button23).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button24).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button25).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button26).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button27).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button21).setOnLongClickListener(new Vetores8.MyOnLongClickListener());
        findViewById(R.id.button22).setOnLongClickListener(new Vetores8.MyOnLongClickListener());



        findViewById(R.id.flexTop).setOnDragListener(new Vetores8.MyOnDragListener(1));
        findViewById(R.id.flexDown).setOnDragListener(new Vetores8.MyOnDragListener(2));
    }
    @Override
